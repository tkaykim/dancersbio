...
export default function ViralCTACard({ className }: { className?: string }) {
    return (
        <div className={cn("w-full px-6 py-4", className)}>
            <div className="relative overflow-hidden rounded-2xl bg-neutral-900 border border-neutral-800 p-6 text-white">
                ...
                <div className="relative z-10">
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-xs font-semibold uppercase tracking-wider bg-white/5 px-2 py-0.5 rounded text-white/70">
                            For Dancers
                        </span>
                    </div>
